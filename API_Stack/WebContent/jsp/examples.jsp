	...
	<div class="contentBoard">
		<div class="mainContent" id="examplesBoard">
			<%
				...
				//java.util.List<Example> examples = dao.getExample((Integer) (session.getAttribute("mid")));
				List<Example> examples = (List<Example>) request.getSession().getAttribute("examples");
